...
try {
    ...
    if (!fetchFn)
        fetchFn = __webpack_require__(17);
}
catch (e) {
    // final fallback
    // @ts-ignore
        ...
        selectionTimeout = setTimeout(async () => {
            ...
            try {
                ...
                if (explanationCache.size > MAX_CACHE) {
                    // remove oldest (simple): keys().next()
...
/* harmony import */ var whatwg_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(18);
...
exports.URL = __webpack_require__(19)["interface"];
exports.serializeURL = __webpack_require__(23).serializeURL;
exports.serializeURLOrigin = __webpack_require__(23).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(23).basicURLParse;
exports.setTheUsername = __webpack_require__(23).setTheUsername;
exports.setThePassword = __webpack_require__(23).setThePassword;
exports.serializeHost = __webpack_require__(23).serializeHost;
exports.serializeInteger = __webpack_require__(23).serializeInteger;
exports.parseURL = __webpack_require__(23).parseURL;
...
const conversions = __webpack_require__(20);
const utils = __webpack_require__(21);
const Impl = __webpack_require__(22);
...
const usm = __webpack_require__(23);
